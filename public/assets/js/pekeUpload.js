...
(function($) {
  ...
  $.fn.pekeUpload = function(options){
    ...
    var defaults = {
      onSubmit:       false,
      btnText:        "Upload new batch of codes",
      url:        "upload.php",
      theme:        "custom",
      field:        "file",
    ...
    this.each(function() {
      ...
      var html = '<a href="javascript:void(0)" class=" btn-upload theme_btn" style="display:inline;"> <span class="icon-upload icon-white"></span> '+options.btnText+'</a><div class="pekecontainer"></div>';
      }
      if (options.theme == "custom"){
        var html = '<a href="javascript:void(0)" class="btn-pekeupload theme_btn">'+options.btnText+'</a><div class="pekecontainer"></div>';
      }
